...
import {
  ...
  Package, DollarSign, TrendingUp, Send, Check, MapPin,
} from "lucide-react";
        ...
        {p.ubicacion && (
          <>
            <button
              ...
              aria-label="Ver ubicación" title="Ver ubicación"
            >
              <MapPin size={11} color="#6B5B52" />
            </button>
            {showLoc && (
              <div className="absolute top-7 right-1.5 rounded-lg px-2 py-1 text-[10px] shadow-md" style={{ background: "#2B2320", color: "#F7F3EC" }}>
                {p.ubicacion}
              </div>
            )}
          </>
